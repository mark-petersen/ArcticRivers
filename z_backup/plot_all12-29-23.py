...
#########################################################################
# riverList = ['Ob','Lena','Kolyma','Yukon', 'Mack']
riverList = ['Yen']
...
for river in riverList:
    ...
    if Threshold:
        ...
        print('convertFtoC', convertFtoC)
        print('max(TempVar)', max(TempVar))
